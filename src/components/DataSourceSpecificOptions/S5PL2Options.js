...
const S5PL2Options = ({ reduxTimeliness, reduxMinQa, idx }) => {
  ...
  return (
    <div>
      ...
      <label className="form__label u-margin-top-tiny">Timeliness</label>
      <select className="form__input" onChange={handleTimelinessChange} value={reduxTimeliness}>
        <option value="DEFAULT">Default</option>
        <option value="NRTI">NRTI</option>
        <option value="OFFL">OFFL</option>
        <option value="RPRO">RPRO</option>
      </select>
      <label className="form__label">MinQa</label>
      <div className="minqa-option">
        ...
        <div className="minqa-option--checkbox">
          ...
          />
          <label htmlFor="enable-minQa" className="text" style={{ display: 'inline-block' }}>
